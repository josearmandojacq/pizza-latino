      ...
      <div class="mt-6 flex items-center space-x-4">
        ...
        <div class="mt-6" style="display: none;" id="downloadBtnDiv">
          <form action="/generate_invoice" method="POST">
            ...
            <input type="hidden" name="pizzaExtras" value="<?= htmlspecialchars(implode(", ", $order["pizzaExtras"])) ?>">
            <input type="hidden" name="specialWishes" value="<?= htmlspecialchars($order["specialWishes"]) ?>">
        ...
        <div class="mt-6">
          <a href="/menu" class="bg-orange-500 text-white text-base px-6 py-2 rounded hover:bg-orange-600 inline-flex items-center justify-center">Züruck</a>
        </div>
      </div>
